...
class FrameAnalyser(private var context: Context, private val activity: Activity, private var boundingBoxOverlay: BoundingBoxOverlay ) : ImageAnalysis.Analyzer {
